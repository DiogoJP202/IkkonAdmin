    ...
    IConfiguracaoSistemaProvider configuracaoProvider) : IConfiguracaoQueryService
{
    ...
    private static ConfiguracoesFormViewModel MapearFormulario(ConfiguracaoSistema config)
    {
        return new ConfiguracoesFormViewModel
        {
            ...
            GerarAulasAutomaticamente = config.GerarAulasAutomaticamente,
            AvaliarConquistasAutomaticamente = config.AvaliarConquistasAutomaticamente,
            HorarioAutomacoesAreaAluno = config.HorarioAutomacoesAreaAluno,
            HorizonteGeracaoAulasSemanas = config.HorizonteGeracaoAulasSemanas,
